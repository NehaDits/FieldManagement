...
namespace FieldMgt.Core.Migrations
{
    ...
    [Migration("20210811102708_FieldMgt.Core.fgrekkk")]
    partial class FieldMgtCorefgrekkk
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.PermissionType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.RolePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.StaffOrganization", b =>
                {
                    b.Property<int>("StaffOrganizationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("StaffOrganizationName")
                        .IsRequired()
                        .HasColumnType("nvarchar(100)");

                    b.HasKey("StaffOrganizationId");
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.ApplicationUser", b =>
                {
                    ...
                    b.HasIndex("StaffOrganizationId");
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.Client", b =>
                {
                    b.HasOne("FieldMgt.Core.DomainModels.AddressDetail", "ClientBillingAddress")
                        .WithMany("ClientBillingAddress")
                    ...
                    b.HasOne("FieldMgt.Core.DomainModels.AddressDetail", "ClientPermanentAddress")
                        .WithMany("ClientPermanentAddress")
                        .HasForeignKey("PermanentAddressId")
                        .HasConstraintName("ClientPermaAddress_FK");

                    b.Navigation("ClientBillingAddress");
                    ...
                    b.Navigation("ClientPermanentAddress");
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.StaffOrganization", b =>
                {
                    ...
                    b.HasOne("FieldMgt.Core.DomainModels.ApplicationUser", "StaffOrganizationCreatedBy")
                        .WithMany("Ref99Navigation")
                        .HasForeignKey("CreatedBy")
                        .HasConstraintName("SOCreatedBy_FK");

                    b.HasOne("FieldMgt.Core.DomainModels.ApplicationUser", "StaffOrganizationDeletedBy")
                        .WithMany("Ref101Navigation")
                        .HasForeignKey("DeletedBy")
                        .HasConstraintName("SODeletedBy_FK");

                    b.HasOne("FieldMgt.Core.DomainModels.ApplicationUser", "StaffOrganizationModifiedBy")
                        .WithMany("Ref100Navigation")
                        .HasForeignKey("ModifiedBy")
                    ...
                    b.Navigation("StaffOrganizationCreatedBy");

                    b.Navigation("StaffOrganizationDeletedBy");

                    b.Navigation("StaffOrganizationModifiedBy");
                });
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.ApplicationUser", b =>
                {
                    ...
                    b.HasOne("FieldMgt.Core.DomainModels.StaffOrganization", "StaffOrganization")
                        .WithMany()
                        .HasForeignKey("StaffOrganizationId");

                    b.Navigation("RefCreatedBy");

                    b.Navigation("RefDeletedBy");

                    b.Navigation("StaffOrganization");
                });
            ...
            modelBuilder.Entity("FieldMgt.Core.DomainModels.ApplicationUser", b =>
                {
                    b.Navigation("Ref100Navigation");

                    b.Navigation("Ref101Navigation");
                    ...
                    b.Navigation("Ref96Navigation");

                    b.Navigation("Ref97Navigation");

                    b.Navigation("Ref98Navigation");

                    b.Navigation("Ref99Navigation");
