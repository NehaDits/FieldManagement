...
namespace FieldMgt.Repository.Repository
{
    public class ClientContactRepository : GenericRepository<ClientContact>, IClientContactRepository
    {
        ...
        public ClientContactRepository(ApplicationDbContext dbContext, IMapper mapper,IUnitofWork uow) : base(dbContext)
        {
        ...
        public async Task UpdateClientContact(UpdateClientContactDTO clientContact)
        {
            try
            {
                await CollectionsAsync<Task>(StoreProcedures.UpdateClientContact, clientContact);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        public ClientContact DeleteClientContact(int ClientContactId, string deletedBy)
        {
            try
            {
                var clientContact = _dbContext.ClientContacts.SingleOrDefault(a => a.ClientContactId == ClientContactId);
